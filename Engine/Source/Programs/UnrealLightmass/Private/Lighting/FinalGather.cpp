...
void FStaticLightingSystem::CalculateVolumeSampleIncidentRadiance(
	...
	// @LGPU 5.3 add from LGPU 5.1.1 PrecomputedUpperSample,PrecomputedLowerSample
	const FFinalGatherSample3& PrecomputedUpperSample,
	const FFinalGatherSample3& PrecomputedLowerSample,
	bool bUsePrecomputedSample,
...
) const
{
	...
	// @LGPU 5.3 add from LGPU 5.1.1
	if (!bUsePrecomputedSample)
	...
	if (bUsePrecomputedSample)
		UpperHemisphereSample = PrecomputedUpperSample;
	else
	...
	if (bUsePrecomputedSample)
		LowerHemisphereSample = PrecomputedLowerSample;
	else
