...
public class UnrealLightmass : ModuleRules
{
	public UnrealLightmass(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// @LGPU 5.3 GPULightmass for Luoshuangs-GPULightmass-5.3-preview
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			string SDKDir = Target.UEThirdPartySourceDirectory + "GPULightmass/Win64/";

			PublicIncludePaths.Add(SDKDir + "include");
			PublicAdditionalLibraries.Add(SDKDir + "lib/GPULightmassKernel.lib");
			RuntimeDependencies.Add("$(EngineDir)/Binaries/Win64/GPULightmassKernel.dll");
		}
	}
}
