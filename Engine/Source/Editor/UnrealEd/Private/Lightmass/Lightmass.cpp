...
void FLightmassExporter::WriteSceneSettings( Lightmass::FSceneFileHeader& Scene )
{
	...
	// @LGPU 5.3 from 5.1.1
	VERIFYLIGHTMASSINI(GConfig->GetInt(TEXT("DevOptions.GPULightmass"), TEXT("NumPrimaryGISamples"), Scene.GPULightmassSettings.NumPrimaryGISamples, GLightmassIni));
	VERIFYLIGHTMASSINI(GConfig->GetInt(TEXT("DevOptions.GPULightmass"), TEXT("NumSecondaryGISamples"), Scene.GPULightmassSettings.NumSecondaryGISamples, GLightmassIni));
	VERIFYLIGHTMASSINI(GConfig->GetFloat(TEXT("DevOptions.GPULightmass"), TEXT("FireflyClampingThreshold"), Scene.GPULightmassSettings.FireflyClampingThreshold, GLightmassIni));
